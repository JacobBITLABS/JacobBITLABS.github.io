---
layout: page
title: DM890 - Computer Vision
description: TA in class for responsible professor Aritra Dutta
img: assets/img/deep_learning_dm890.png
importance: 1
category: work
---
...
[<a href="https://odin.sdu.dk/sitecore/index.php?a=fagbesk&id=115911&lang=en&listid=">Full Course Description | ODIN</a>]

I was responsible for the lecture in convolutional neural networks (CNNs). 
The slides can be accessed here: [<a href="{{'assets/pdf/deep_neural_networks_cnns.pdf' | relative_url}}">Lecture: Convolutional Neural Networks</a>]
